...
export default function CreatePost() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(data)
      console.log(data.pairs.slug)

      if (res.ok) {
        setPublishError(null);
        navigate(`/post/${data.pairs.slug}`);
      }
    } catch (error) {
        ...
        <div className='flex flex-col gap-4 sm:flex-row justify-between'>
          ...
          >
            <option value="uncategorized">Uncategorized</option>
              ...
              <option value="Entrepreneurship Tips">Entrepreneurship Tips</option>
              ...
              <option value="Mentorship and Coaching">Mentorship and Coaching</option>
